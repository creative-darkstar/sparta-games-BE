...
urlpatterns = [
    ...
    path("api/list/<int:game_id>/register/", views.game_register_v2, name="game_register"),
    path("api/list/task-status/<uuid:task_id>/", views.get_task_status, name="get_task_status"),
